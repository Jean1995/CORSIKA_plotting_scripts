...
if (len(sys.argv) != 5):
    print("Usage: create_plots.py PATH_TO_C7_FOLDER PATH_TO_C8_FOLDER PROFILE_FOLDER_NAME OUTPUT_NAME")
    assert(False)
...
NAME_PROFILE_FOLDER_C8 = sys.argv[3] # change name of folder where C8 profiles are stored
